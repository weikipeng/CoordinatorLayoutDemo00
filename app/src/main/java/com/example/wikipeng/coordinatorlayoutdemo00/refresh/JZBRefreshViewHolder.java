 ...
 */
public abstract class JZBRefreshViewHolder {
    /**
     ...
     * 下拉刷新上拉加载更多控件
     */
    protected JZBRefreshLayout mRefreshLayout;
    /**
     * 下拉刷新控件
     */
     ...
     */
    public JZBRefreshViewHolder(Context context, boolean isLoadingMoreEnabled) {
        mContext = context;
     ...
     * @param refreshLayout
     */
    public void setRefreshLayout(JZBRefreshLayout refreshLayout) {
